...
def tool_prompt_instruction() -> str:
    return (
        ...
        "For the status_effects tool, arguments must be {\"status_effects\":[{\"effect_id\":\"HP_Damage/SP_Damage/Paralysis/Silence/Psychosis/Inoperable/SendLLM/Atk_Mod/Def_Mod/accuracy_mod/damage_taken_mod/element_res_mod/stun/thorns/str_mod/dex_mod/con_mod/int_mod/wis_mod/cha_mod\",...}]}; "
        "status effects without explicit effect_id are ignored. accuracy_mod adds its amount to hit rolls. "
        "damage_taken_mod, element_res_mod, and thorns use 10% per amount. element_res_mod may include element or target_element; omit it for all elements. "
