...
SCHEMAS: dict[str, ManagerSchema] = {
    ...
    "quest_objective_npc_designer": ManagerSchema(
        ...
        fields=(
            ...
            FieldRule("look_details", (dict,), required=False, non_empty=False, string_items=False),
            FieldRule("personality_details", (dict,), required=False, non_empty=False, string_items=False),
        ...
        example={
            ...
            "look_details": {"clothing": "", "skin_color": "", "eye_color": "", "hair_color": ""},
            "personality_details": {"person_type": "執念深い妨害者", "life_history": "森に迷い込んだ者を捕らえてきた。"},
            "species": "魔物",
    ...
    "npc_detail_generater": ManagerSchema(
        ...
        example={
            ...
            "personality": "警戒心が強いが、困っている相手には助言を惜しまない。",
            "look": "濡れた旅外套、薬草袋、小さな銀の鈴を身につけている。",
            "look_details": {"clothing": "濡れた旅外套", "skin_color": "淡い褐色", "eye_color": "灰青色", "hair_color": "暗い栗色"},
            "personality_details": {"person_type": "慎重だが親切な薬師", "life_history": "薬草を求めて雨の多い街道を巡ってきた。"},
