...
STATUS_EFFECT_LABELS_EN = {
    ...
    "stun": "Stun",
    "thorns": "Thorns",
    "regen_hp": "HP regeneration",
    "regen_sp": "SP regeneration",
    "decrease_hp": "HP degeneration",
    "decrease_sp": "SP degeneration",
...
STATUS_EFFECT_DESCRIPTIONS_JA = {
    ...
    "regen_hp": "時間経過やターンごとにHPが回復する。",
    "regen_sp": "時間経過やターンごとにSPが回復する。",
    "decrease_hp": "時間経過やターンごとにHPが減少する。",
    "decrease_sp": "時間経過やターンごとにSPが減少する。",
...
STATUS_EFFECT_ALIASES = {
    ...
    "regen_sp": "regen_sp",
    "sp_regen": "regen_sp",
    "regeneration_sp": "regen_sp",
    "decrease_hp": "decrease_hp",
    "hp_decrease": "decrease_hp",
    "decrease_sp": "decrease_sp",
    "sp_decrease": "decrease_sp",
